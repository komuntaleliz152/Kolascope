...
import { Loader2, Copy, CheckCheck, Wand2, RefreshCw, Trash2, FileText, Briefcase, Handshake, Zap, Download } from "lucide-react";
...
export default function ProposalWriter({ user, onAuthRequired }: Props) {
  ...
  function exportToPDF() {
    import("jspdf").then(({ default: jsPDF }) => {
      ...
      doc.setFontSize(16);
      doc.text("Freelance Proposal", margin, margin);

      doc.setFont("helvetica", "normal");
      doc.setFontSize(10);
      doc.setTextColor(100);
      doc.text(`Tone: ${tone} · Generated by Kolaborate AI`, margin, margin + 8);
